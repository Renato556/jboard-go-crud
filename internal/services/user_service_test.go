...
func TestUserService_CreateUser_UsernameAlreadyExists(t *testing.T) {
	...
	mockRepo := &mockUserRepository{
		findByUsernameFunc: func(ctx context.Context, username string) (models.User, bool, error) {
			return models.User{ID: existingID, Username: username}, true, nil
		},
	}
...
func TestUserService_GetUserByID_Success(t *testing.T) {
	...
	user, err := service.GetUserByID(ctx, testID.Hex())
	...
	if user.ID != expectedUser.ID {
		t.Errorf("Expected user ID %s, got %s", expectedUser.ID.Hex(), user.ID.Hex())
	}
}
...
func TestUserService_GetUserByID_NotFound(t *testing.T) {
	...
	_, err := service.GetUserByID(ctx, primitive.NewObjectID().Hex())
...
func TestUserService_UpdateUser_Success(t *testing.T) {
	...
	if updatedUser.ID != testID {
		t.Errorf("Expected ID %s, got %s", testID.Hex(), updatedUser.ID.Hex())
	}
}
...
func TestUserService_UpdateUser_EmptyPassword(t *testing.T) {
	...
	mockRepo := &mockUserRepository{
		...
		updateByIDFunc: func(ctx context.Context, id string, user models.User) error {
			...
			if user.Password != "oldpass" {
				t.Errorf("Expected password to be preserved as 'oldpass', got %s", user.Password)
			}
			return nil
		},
	}
	...
	updatedUser, err := service.UpdateUser(ctx, "testuser", "", enums.Premium)
